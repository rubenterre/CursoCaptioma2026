...
function cambiarRaza(raza) {
    ...
    switch (raza) {
        case "Protoss":
            ...
            iconoProtoss.src = razas.Protoss.iconoBotonActive;
        ...
        case "Terran":
            ...
            iconoTerran.src = razas.Terran.iconoBotonActive;
            iconoZerg.src = razas.Zerg.iconoBotonDefault;
        ...
        case "Zerg":
            ...
            iconoProtoss.src = razas.Protoss.iconoBotonDefault;
            iconoTerran.src = razas.Terran.iconoBotonDefault;
            iconoZerg.src = razas.Zerg.iconoBotonActive;
    ...
    document.getElementById("tituloRaza").textContent = razaSeleccionada.nome;
    document.getElementById("descripcionRaza").textContent = razaSeleccionada.descricion;
...
function toggleMenu() {
    let headerContainer = document.querySelector(".menu--mobile");
